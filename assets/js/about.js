...
function espTrad() {
  ...
  document.getElementById('motivacion').innerHTML = textAbout['motivacion'];
  document.getElementById('contenido').innerHTML = textAbout['contenido'];
  document.getElementById('comentario').innerHTML = textAbout['comentario'][0] + '<br><br>' + textAbout['comentario'][1] + '<br><br>' + textAbout['comentario'][2] + '<br><br>' + textAbout['comentario'][3];
