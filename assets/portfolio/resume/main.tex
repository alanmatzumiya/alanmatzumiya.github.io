...
\fcolorbox{white}{sectcol}{\begin{minipage}[c][0.96\textheight][t]{0.33\linewidth}
		...
		\begin{metasection}{Aptitudes y Habilidades}
			...
			\cvskill{\icontext{Code}{12}{Python / JavaScript}{white}} {7+ a} {1} \\[6pt]
			\cvskill{\icontext{Code}{12}{Visual Basic / PHP}{white}} {8+ a} {0.85} \\[6pt]
			\cvskill{\icontext{Code}{12}{C++ / Fortran}{white}} {8+ a.} {1} \\[6pt]
			\cvskill{\icontext{AreaChart}{12}{R / Matlab}{white}} {7+ a} {0.90} \\[6pt]
			\cvskill{\icontext{Code}{12}{HTML / CSS / Markdown}{white}} {5+ a} {0.95} \\[6pt]
			\cvskill{\icontext{Database}{12}{MySQL / MariaDB}{white}} {5+ a} {0.90}
