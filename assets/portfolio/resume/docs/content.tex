...
%
\cvevent{2021 - 2023}{Ingeniero de Operaciones de Planta}{Windstar LPG}{Control y gestión de inventarios con Excel y QlikView, elaboración y aprobación de balances de masa en productos refinados de petróleo (LPG, diésel y gasolinas).}{Compra y venta de LPG con Microsoft Dynamics GP, gestión de personal, actividades en cadena de suministro para transporte por carretera y comercio minorista.}
